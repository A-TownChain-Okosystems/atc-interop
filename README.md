...
> Bridges/IBC sind eine eigene Sicherheitsdomaene - wegen Bridge-Security NIEMALS ein Unterordner des Cores.
...
```
atc-interop (eigene Sicherheitsdomaene)
    +-- bridge/ - ibc/ - evm/ - solana/
    +-- relayer/ - message/ - proofs/
    +-- verification/ - security/

Langfristig: Ethereum - Polygon - BSC - Solana -
Cosmos/IBC - A-TownChain
```
